...
\begin{figure}[ht!]
    \centering
    \includegraphics[scale=0.4]{figs/mapping-network.eps}
...
\bibitem[1]{dalle} A. Ramesh, M. Pavlov, G. Goh, S. Gray, C. Voss, A. Radford, M. Chen, I. Sutskever, {\it Zero-Shot Text-to-Image Generation}, \url{https://arxiv.org/pdf/2102.12092.pdf}

\bibitem[2]{dalle-blog} \url{https://openai.com/blog/dall-e/}

\bibitem[3]{gan} I. Goodfellow et al.  {\it Generative Adversarial Nets} 2014.  \url{https://arxiv.org/pdf/1406.2661.pdf}

\bibitem[4]{hand} B. Davis, C. Tensmeyer, B. Price, C. Wigington, B. Morse, B. Jain,  {\it Text and Style Conditioned GAN for
Generation of Offline Handwriting Lines},  \url{https://arxiv.org/pdf/2009.00678.pdf}

\bibitem[5]{superres} C. Ledig, L. Theis, F.  Huszar, J. Caballero, A. Cunningham, ´
...
\bibitem[6]{blend} H. Wu, S. Zheng, J. Zhang, K. Huang, {\it GP-GAN: Towards Realistic High-Resolution Image Blending}, \url{https://arxiv.org/pdf/1703.07195.pdf}

\bibitem[7]{progress_gan} https://medium.com/mlearning-ai/generative-everything-the-technology-that-brought-you-deepfakes-soon-brings-you-3777a8bccee7
...
\bibitem[9]{gan_arch} \url{https://machinelearningmastery.com/what-are-generative-\\adversarial-networks-gans/}

\bibitem[10]{improvedgans} T. Salimans, I. Goodfellow, W. Zaremba, V. Cheung, A. Radford, and X. Chen. {\it Improved techniques for training gans.} In NIPS, 2016.

\bibitem[11]{inception} C. Szegedy, V. Vanhoucke, S. Ioffe, J. Shlens, Z. Wojna. {\it Rethinking the inception architecture for computer vision.} arXiv preprint arXiv: 1512.00567, 2015.

\bibitem[12]{fid} M. Heusel, H. Ramsauer, T. Unterthiner, B. Nessler, S. Hochreiter. {\it GANs trained by a two time-scale update rule converge to a local Nash equilibrium.} In NIPS, 2017.

\bibitem[13]{clip} OpenAI CLIP A. Radford, J. W. Kim, C. Hallacy, A. Ramesh, G.Goh, S. Agarwal, G. Sastry, P. Mishkin, J. Clark, G. Krueger, I. Sutskever, {\it Learning Transferable Visual Models From Natural Language Supervision}, \url{https://arxiv.org/pdf/2103.00020.pdf}

\bibitem[14]{clip_blog} \url{https://openai.com/blog/clip/}

\bibitem[15]{clip_source} \url{https://habr.com/en/post/537334/}

\bibitem[16]{de} R. Storn, K. Price. {\it Differential Evolution – A Simple and Efficient Heuristic for global Optimization over Continuous Spaces.} Springer, 1997.

\bibitem[17]{ea} A. N. Sloss, S. Gustafson, {\it 2019 Evolutionary Algorithms Review},\url{https://arxiv.org/pdf/1906.08870.pdf}

\bibitem[18]{coimbra} P. Fernandes, J. Correia, P. Machado {\it Evolutionary Latent Space Exploration of Generative Adversarial Networks.} CISUC, Department of Informatics Engineering University of Coimbra, 2020.

\bibitem[19]{stylegan} T. Karras, S. Laine, T. Aila. {\it A style-based generator architecture for generative adversarial networks.} In CVPR, 2019.

\bibitem[20]{progan} T. Karras,  T. Aila, S. Laine, J. Lehtinen, {\it PROGRESSIVE GROWING OF GANS FOR IMPROVED
QUALITY, STABILITY, AND VARIATION},\url{https://arxiv.org/pdf/1710.10196.pdf}

\bibitem[21]{adain} X. Huang, S. Belongie, {\it Arbitrary Style Transfer in Real-time with Adaptive Instance Normalization}, \url{https://arxiv.org/pdf/1703.06868.pdf}

\bibitem[22]{stylegan2} T. Karras, S. Laine, M. Aitala, J. Hellsten, J. Lehtinen, T. Aila, \it{Analyzing and Improving the Image Quality of StyleGAN}, \url{https://arxiv.org/pdf/1912.04958v2.pdf}

\bibitem[23]{biggan} A. Brock, J. Donahue, K. Simonyan {\it Large Scale GAN Training for High Fidelity Natural Image Synthesis.} arXiv preprint arXiv: 1809.11096, 2019.

\bibitem[24]{aphantasia} \url{https://github.com/eps696/aphantasia}

\bibitem[25]{siren} V. Sitzmann, J. Martel, A. Bergman, D. Lindell, G. Wetzstein {\it Implicit Neural Representations with Periodic Activation Functions.} arXiv preprint arXiv: 2006.09661, 2020.

\bibitem[26]{vqgan} P. Esser, R. Rombach, B. Ommer {\it Taming Transformers for High-Resolution Image Synthesis.} arXiv preprint arXiv: 2012.09841, 2021.

\bibitem[27]{bigsleep} \url{https://github.com/lucidrains/big-sleep}

\bibitem[28]{deepai} \url{https://deepai.org/machine-learning-model/text2img}

\bibitem[29]{pymoo} \url{https://github.com/msu-coinlab/pymoo}

\bibitem[30]{clipresults} https://github.com/lucidrains/DALLE-pytorch/discussions/131

\bibitem[31]{cifar10_data} \url{https://www.cs.toronto.edu/~kriz/cifar.html}

\bibitem[32]{imagenet_example} \url{https://devopedia.org/imagenet}

\bibitem[33]{imagenet_data} \url{https://www.image-net.org/}

\bibitem[34]{cifar10_classifier} \url{https://github.com/vrakesh/CIFAR-10-Classifier}

\bibitem[35]{resnet} \url{https://pytorch.org/hub/pytorch_vision_resnet}
